...
from tools import get_weather_for_area
...
weather_agent = Agent(
    ...
    instruction=(
        "you ask the user where he is going, get the weather conditions for that day and suggest things to note for his wellbeing"
    ),
    tools=[get_weather_for_area], #giving agent access to the tool
)
...
async def main():
    ...
    print("🌤️  Weather Agent Chat Started!")
    print("Type your questions about weather and locations.")
    ...
    while True:
        try:
            ...
            if user_input.lower() in ['quit', 'exit', 'bye', 'q']:
                print("\n👋 Thanks for using Weather Agent! Goodbye!")
                break
